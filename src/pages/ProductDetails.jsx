          ...
          singleproduct.map(item => (
            <>
              ...
              <div className='flex'>
                <div className='mr-7'>
                  {
                    ...
                    item.images.map(item2 => (
                      <div className='pb-4'>
                        <Image className='w-[150px]' src={item2} />
                      </div>
                    ))
                  }
                ...
                <div className='ml-18'>
                  <p className='text-2xl font-semibold  font-int'>{item.title}</p>
                  <div className='flex  py-4'>
                    ...
                    <p className='text-sm text-[#00FF66] font-pop font-normal'>In Stock {item.stock}</p>

                  </div>
                  <p className='text-2xl font-normal  font-int'>{item.price}$</p>
                  <p className='text-sm text-black font-pop font-normal leading-[23px] w-[353px] py-6'>{item.description}</p>
